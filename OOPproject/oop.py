...
class SpaceGameWindow(arcade.Window):
    ...
    def on_draw(self):
        if self.world.STATE == 0:
            ...
            arcade.draw_text("P2 LIFE :" + str(self.world.player2.LIFE), 900, 500, arcade.color.BLACK, 20)
            arcade.draw_text("P1 LIFE :" + str(self.world.player.LIFE), 900, 100, arcade.color.BLACK, 20)
